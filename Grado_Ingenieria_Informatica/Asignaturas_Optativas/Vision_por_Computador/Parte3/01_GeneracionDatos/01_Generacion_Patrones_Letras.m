...
pathArchivos = pathMain + "Imagenes\ImagenesLetras\"

addpath(pathMain + "Funciones");

addpath(pathArchivos + 'Entrenamiento\');
...
save(pathMain + '01_GeneracionDatos/DatosLetras/ConjuntoDatosXY.mat','X','Y');
save(pathMain + '01_GeneracionDatos/DatosLetras/nombresProblema','nombresProblema');

rmpath("Funciones");
rmpath(pathArchivos + 'Entrenamiento');