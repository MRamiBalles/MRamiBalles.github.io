...
int main() {
 ...
 const Fecha f2=f1; //indica que metodo se esta ejecutando aqui -> operador de asignacion (por defecto)
 ...
 f3=f4++; //indica que método/s se esta ejecutando aqui -> operador de asignacion (por defecto) y operator++(int i)
 ++f4;
 f1=2+f2+3;
 cout << "Fechas: "; f1.ver(); cout << ", "; f2.ver(); cout << ", ";
 f3.ver(); cout << ", "; f4.ver(); cout << endl;
