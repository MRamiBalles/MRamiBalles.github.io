...
fmin = 100; fmax = 200;
cmin = 150; cmax = 300;
I1mod(fmin:fmax, cmin:cmax) = 255; %Cuadrado blanco en medio
figure, imshow(I1mod)

I2mod(fmin:fmax, cmin:cmax,3) = 0; %Cuadrado blanco en medio
I2mod(fmin:fmax, cmin:cmax,1:2) = 255;
figure, imshow(I2mod)
